...
print(logs("Fichier texte avec des groupes crée correctement ---->"+ "Nom d'utilisateur active : " +getpass.getuser()+" ----> " + " Date : " +str(time)))
fichier_json(dico_groupes)
print(logs("Fichier Json crée correctement ---->"+ "Nom d'utilisateur active : " +getpass.getuser()+" ----> " + " Date : " +str(time)))
print(logs("Fichier texte des logs crée correctement ---->"+ "Nom d'utilisateur active : " +getpass.getuser()+" ----> " + " Date : " +str(time)))
